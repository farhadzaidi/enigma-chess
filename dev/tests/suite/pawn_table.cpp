...
bool test_pawn_table_eval_cache(Board& b) {
    ...
    PawnTableEntry start_entry = g_pawn_table.get_pawn_score(b);
    ...
    PawnTableEntry after_non_pawn = g_pawn_table.get_pawn_score(b);
    ...
    PawnTableEntry new_entry = g_pawn_table.get_pawn_score(b);

...
bool test_make_unmake_incremental_scores(Board& b) {
    ...
    for (const auto& tc : test_cases) {
        ...
        bool match = (
            b.early_score[WHITE] == rebuilt.early_score[WHITE]
            && b.early_score[BLACK] == rebuilt.early_score[BLACK]
            && b.late_score[WHITE] == rebuilt.late_score[WHITE]
            && b.late_score[BLACK] == rebuilt.late_score[BLACK]
        ...
        if (!match) {
            ...
            std::clog << "Incremental early[W]/[B]: " << b.early_score[WHITE] << "/" << b.early_score[BLACK]
                      << " Rebuilt: " << rebuilt.early_score[WHITE] << "/" << rebuilt.early_score[BLACK] << "\n";
            std::clog << "Incremental late[W]/[B]: " << b.late_score[WHITE] << "/" << b.late_score[BLACK]
                      << " Rebuilt: " << rebuilt.late_score[WHITE] << "/" << rebuilt.late_score[BLACK] << "\n";

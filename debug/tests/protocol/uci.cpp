...
const std::string STARTPOS_SEQ_EXPECTED_FEN =
    "r1bqkbnr/pppp1ppp/2n5/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 2 3";

const std::string FEN_SEQ_EXPECTED_FEN =
    "rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2";

bool board_position_equal_ignoring_ply(const Board& a, const Board& b) {
    Board a_copy = a;
    Board b_copy = b;
...
bool test_calc_time_limit_movestogo_branch(Board& b) {
...
bool test_calc_time_limit_phase_branch(Board& b) {
    b.load_from_fen(START_POS_FEN);
...
bool test_cmd_setoption_toggles() {
...
bool test_cmd_position_parsing(Board& b) {
    // startpos + moves
...
bool test_cmd_ucinewgame_clears_state(Board& b) {
    b.load_from_fen(START_POS_FEN);
